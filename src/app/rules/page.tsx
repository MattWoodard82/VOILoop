...
const rules = [
  {
    title: 'Accrual',
    body: 'Points accrue daily from eligible wellness activities. During pilot rollout phases, the operator team manages point balances and recomputes them from the source of truth.',
  },
  {
    title: 'Caps',
